...
$(BUILDDIR)$(LV2NAME).ttl: Makefile lv2ttl/$(LV2NAME).ttl.in lv2ttl/$(LV2NAME).head.ttl.in lv2ttl/$(LV2NAME).gui.in
	@mkdir -p $(BUILDDIR)
...
CPPFLAGS = -Ifluidsynth -DHAVE_CONFIG_H -D DEFAULT_SOUNDFONT=\"\"
